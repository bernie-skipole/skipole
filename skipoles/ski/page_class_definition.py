...
class RespondPage(ParentPage):
    ...
    def call_responder(self, skicall, lang, form_data, caller_ident, ident_list, rawformdata, error_dict=None):
        ...
        page = self.responder(skicall, lang, form_data, caller_ident, ident_list, proj, rawformdata, error_dict)
        return page
