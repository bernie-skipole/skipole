...
class Project(object):
    ...
    def __init__(self, proj_ident, url="/"):
        ...
        # An instance of the AccessTextBlocks class
        self.textblocks = AccessTextBlocks(self._proj_ident, 
...
class AccessTextBlocks(object):
    ...
    def __init__(self, project, projectfiles, default_language):
        """The project creates an instance of this class, and uses it to read TextBlocks
           As default, TextBlocks are stored in JSON files beneath the data/textblocks_json,dictionary
           however if you wish to store them elsewhere you can re-write this module and class
           Doing so, however may make your project less portable, and skiadmin textblock edit and project
           import and copy could fail.
