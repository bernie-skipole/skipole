    ...
    def _respond(self, skicall, environ, lang, form_data, caller_page, ident_list, proj_ident, rawformdata):
        ...
        if self.widgfield in form_data:
            ...
            if value in self.fields:
                return self.get_page_from_ident(self.fields[value], skicall, environ, lang, form_data, caller_page, ident_list, proj_ident, rawformdata)
        return self.get_alternate_page(skicall, environ, lang, form_data, caller_page, ident_list, proj_ident, rawformdata)
